...
CLINIC_GEO = {
    "aker-brygge":                    {"lat": 59.9103,  "lng": 10.7259,  "radius": 5,  "unit": "km"},
    ...
    "broegelmannhuset":               {"lat": 60.3938,  "lng": 5.3236,   "radius": 5,  "unit": "km"},
    ...
    "galleri-oslo":                   {"lat": 59.911,   "lng": 10.758,   "radius": 5,  "unit": "km"},
    ...
    "homansbyen":                     {"lat": 59.923,   "lng": 10.728,   "radius": 5,  "unit": "km"},
    ...
    "leutenhaven":                    {"lat": 63.43,    "lng": 10.39,    "radius": 5,  "unit": "km"},
    "levanger":                       {"lat": 63.7461,  "lng": 11.2982,  "radius": 25, "unit": "km"},
    "lillehammer":                    {"lat": 61.115,   "lng": 10.4672,  "radius": 30, "unit": "km"},
    "lykkegarden-tidligere-trondheim-torg": {"lat": 63.431, "lng": 10.395, "radius": 5, "unit": "km"},
    ...
    "munkegata":                      {"lat": 63.431,   "lng": 10.394,   "radius": 5,  "unit": "km"},
    ...
    "nationaltheatret-tannregulering":{"lat": 59.914,   "lng": 10.73,    "radius": 5,  "unit": "km"},
    ...
    "oralkirurgisk-klinikk":          {"lat": 59.93,    "lng": 10.71,    "radius": 5,  "unit": "km"},
    ...
    "sanden":                         {"lat": 63.43,    "lng": 10.385,   "radius": 5,  "unit": "km"},
    ...
    "skoyen":                         {"lat": 59.921,   "lng": 10.68,    "radius": 5,  "unit": "km"},
    ...
    "strandgaten":                    {"lat": 60.394,   "lng": 5.324,    "radius": 5,  "unit": "km"},
    "tannteam-spesialistklinikk":     {"lat": 60.317,   "lng": 5.352,    "radius": 5,  "unit": "km"},
    "tarnplassen":                    {"lat": 60.392,   "lng": 5.323,    "radius": 5,  "unit": "km"},
